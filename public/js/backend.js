...
$('body').on('click', '.btn-delete', function (event) {
    ...
    var me = $(this),
        url = me.attr('href'),
        tit = me.attr('title'),
        confirm = me.attr('data-trans-button-confirm') ? me.attr('data-trans-button-confirm') : 'Continue';
        title = me.attr('data-trans-title') ? me.attr('data-trans-title') : 'Are you sure you want to delete this item?';
        text = me.attr('data-trans-text') ? me.attr('data-trans-text') : 'You wont be able to revert this!';
        cancel = me.attr('data-trans-button-cancel') ? me.attr('data-trans-button-cancel') : 'Cancel';
        success = me.attr('data-trans-success') ? me.attr('data-trans-success') : 'Success';
        deleted = me.attr('data-trans-deleted') ? me.attr('data-trans-deleted') : 'Data has been deleted';
        wrong = me.attr('data-trans-wrong') ? me.attr('data-trans-wrong') : 'Something went wrong!';
