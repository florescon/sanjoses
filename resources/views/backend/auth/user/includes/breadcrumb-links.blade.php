<li class="breadcrumb-menu">
    <div class="btn-group" role="group" aria-label="Button group">
        ...
        <form action="{{ route('admin.auth.user.search') }}" method="GET">
            <input class="form-control form-control-sm" type="text" name="search" placeholder="@lang('labels.general.search')" required/>
        </form>
