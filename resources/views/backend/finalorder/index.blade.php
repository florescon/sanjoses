...
@section('title', app_name() . ' | ' . __('labels.backend.access.finalorder.management'))
...
<div class="card card-accent-info">
    <div class="card-body">
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('labels.backend.access.finalorder.management') }}
                </h4>
            </div><!--col-->

            <div class="col-sm-7">
				<div class="btn-toolbar float-right" role="toolbar" aria-label="@lang('labels.general.toolbar_btn_groups')">
				    <a href="{{ route('admin.finalorder.create') }}" class="btn btn-success ml-1" title="@lang('labels.general.create_new')"><i class="fas fa-plus-circle"></i></a>
				</div><!--btn-toolbar-->
        ...
        <div class="row mt-4">
            <div class="col">
            <h4 class="card-title mb-0">
              <small class="text-muted"><em>@lang('labels.backend.access.finalorder.filter_by_date_created')</em></small>
            </h4>
            <br>
            ...
            <br />
                <div class="table-responsive">
                    <table class="table table-striped data-table" style="width:100%">
                        <thead>
                        <tr>
                            <th>@lang('labels.backend.access.finalorder.table.folio')</th>
                            <th>@lang('labels.backend.access.finalorder.client')</th>
                            <th>@lang('labels.backend.access.finalorder.table.comment')</th>
                            <th>@lang('labels.backend.access.finalorder.table.created')</th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="viewLabel">@lang('labels.backend.access.finalorder.view')</h5>
      ...
      <div class="modal-body">
        <input type="hidden" name="id" id="id" value="">
          <div class="form-group">
            <label for="name" class="col-form-label">@lang('labels.backend.access.finalorder.user'):</label>
            <input type="text" class="form-control" id="name" readonly required>
          </div>
          <div class="form-group">
            <label for="name" class="col-form-label">@lang('labels.backend.access.finalorder.payment_method'):</label>
            <input type="payment" class="form-control" id="payment" readonly required>
          </div>
          <div class="form-group">
            <label for="audi" class="col-form-label">@lang('labels.backend.access.finalorder.table.generated_by'):</label>
...
<script>
    $(function () {
      let table = $('.data-table').DataTable({
        ...
        autoWith: false,
        ajax: {
          url: "{{ route('admin.finalorder.index') }}",
          method: 'get',
          data: function (d) {
