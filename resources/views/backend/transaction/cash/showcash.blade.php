  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header">
          ...
          <a href="{{ route('admin.transaction.cash.showcard', $cash->id) }}" class="btn btn-brand btn-facebook mb-1">
            <span>Tarjeta</span>
          </a>
      </div>
    </div>
      ...
      <div class="tab-pane" id="cashout" role="tabpanel">
        <table class="table table-responsive-sm">
          ...
          <tbody>
            ...
            <tr>
              <td>@lang('labels.backend.access.cash_out.table.withdrawal')</td>
              <td><span class="badge badge-pill badge-danger">${{ $cash->withdraw }}</span></td>
            </tr>
            <tr>
              <th style="text-align: right;">Total</th>
              <th>
              @php($final=$cash->initial+$totalsale+$totalinscription+$totalpayment+$totalincomes-$cash->withdraw-$totalexpense)
