...
@section('title', app_name() . ' | ' . __('labels.backend.access.product.history'))
                ...
                <div class="table-responsive">
                    <table class="table table-responsive-sm table-sm data-table">
                        ...
                        <tr>
                            ...
                            <th>@lang('labels.backend.access.product.table.previous_stock')</th>
                            <th>@lang('labels.backend.access.product.table.operation')</th>
                            <th>@lang('labels.backend.access.product.table.stock')</th>
                            <th>@lang('labels.backend.access.product.table.created_by')</th>
