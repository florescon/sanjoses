    ...
    'backend' => [
        'access' => [
            'roles' => [
                ...
                'cant_restore' => 'No puede restaurar.',
            ...
            'general' => [
                'cant_delete' => 'No puede eliminar, tiene datos asociados.',
            ],
    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'created_confirm' => 'Su cuenta ha sido creada. Le hemos enviado un e-mail con un enlace de verificación. Si no se encuentra en la bandeja principal, verifique en spam',
