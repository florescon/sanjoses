...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'image' => 'imagen',
        'mount' => 'monto',
        'start_index' => 'fecha de inicio',
        'start_' => 'fecha de inicio',
        'price_' => 'precio',
        'name' => 'nombre',
        'withdraw' => 'retiro',
        'level' => 'nivel',
        ...
        'frontend' => [
            ...
            'please_fill_' => 'Complete los siguientes campos con la información adecuada para registrar una nueva cuenta ',
            'already_have_' => '¿Ya tienes una cuenta?',
            'leave_your_' => 'Deja tu mensaje',
            'how_can_we_' => '¿Como podemos ayudarte?',
            'address' => 'Dirección',
        ],
    ],
];
