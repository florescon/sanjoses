...
class ProductStockHistoryDataTable extends DataTable
{
    ...
    {
        $query = $query->with('product_stock.product_detail', 'generated_by')->where('type', 1);
    ...
    protected function getColumns()
    {
        return [
            ...
            ['data' => 'product_stock', 'title' => __('labels.backend.access.product.table.name'), 'class' =>'text-center'],
            ['data' => 'old_quantity', 'title' => __('labels.backend.access.product.table.previous_stock')],
            ['data' => 'quantity', 'title' => __('labels.backend.access.product.table.operation')],
            ['data' => 'actual', 'title' => __('labels.backend.access.product.table.stock')],
            ['data' => 'audi', 'title' => __('labels.backend.access.product.table.created_by')],
